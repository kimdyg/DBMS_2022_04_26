...
VALUES('00001', '홍길동', '010-141-1111', '컴공과');

INSERT INTO tbl_student( st_num, st_name, st_tel, st_dept)
VALUES('00002', '이몽룡', '010-141-1112', '전자과');

INSERT INTO tbl_student( st_num, st_name, st_tel, st_dept)
VALUES('00003', '성춘향', '010-141-1113', '정보통신과');
...
SELECT st_num, st_name, st_tel, st_dept, st_addr, st_grade
FROM tbl_student;
...
/*
SELECT 명령 수행
Project : 데이터를 조회할때 보고자 하는 칼럼만 표시하는것
...
INSERT INTO tbl_student(st_num, st_name, st_tel, st_dept)
VALUES('0004', '장영실', '010-141-1114', '컴공과');
INSERT INTO tbl_student(st_num, st_name, st_tel, st_dept)
VALUES('0005', '최순실', '010-141-1115', '컴공과');

-- 학과가 컴공과 안 데이터만 SELECTION 하여
-- 이름(st_name) 순으로 정렬하라
SELECT* 
FROM tbl_student
WHERE st_dept = '컴공과'
...
-- 학과 별로 학생이 몇명인지 알고싶다
SELECT st_dept, COUNT(st_dept) 학생수-- 3 : 묶인 그룹에 포함된 데이터가 몇개?
